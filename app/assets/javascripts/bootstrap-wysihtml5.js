	...
	var templates = {
		"font-styles": "<li class='dropdown'>" +
							"<a class='btn dropdown-toggle' data-toggle='dropdown' href='#'>" +
								"<i class='icon-font'></i>&nbsp;<span class='current-font'>Texto</span>&nbsp;<b class='caret'></b>" +
							"</a>" +
						    "<ul class='dropdown-menu'>" +
						      	"<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='div'>Texto</a></li>" +
		...
		"lists": 	"<li>" 
						+ "<div class='btn-group'>" 
						    ...
						    + "<a class='btn' data-wysihtml5-command='insertOrderedList' title='Lista Ordenada'><i class='icon-th-list'></i></a>"
		...
		"link": 	"<li>" 
				    	...
				    	+ "<a class='btn' data-wysihtml5-command='createLink' title='Insertar Link'><i class='icon-share'></i></a>"
		...
		"html": 
						"<li>"
							+ "<div class='btn-group'>"
								+ "<a class='btn' data-wysihtml5-action='change_view' title='Editar HTML'><i class='icon-pencil'></i></a>"
							+ "</div>"
						+ "</li>"
	};
